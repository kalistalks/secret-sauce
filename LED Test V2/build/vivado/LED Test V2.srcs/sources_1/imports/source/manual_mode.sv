...
module manual_mode #(
    ...
    logic [31:0] R_6c3defbd_index;
    logic [31:0] RR_6c3defbd_index;
    localparam logic [3:0][23:0] COLOR_ENCODING = {{24'hffffff, 24'hff0000, 24'hff00, 24'h0}};
    ...
    localparam _MP_CLK_FREQ_1694834469 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_1694834469 = 5'h14;
    localparam _MP_NUM_SYNC_1694834469 = 2'h2;
    logic M_latch_button_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1694834469),
        .MIN_DELAY(_MP_MIN_DELAY_1694834469),
        .NUM_SYNC(_MP_NUM_SYNC_1694834469)
    ) latch_button (
        .in(io_button[1'h0]),
        .clk(clk),
    ...
    localparam _MP_RISE_1785973542 = 1'h1;
    localparam _MP_FALL_1785973542 = 1'h0;
    logic M_latch_button_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1785973542),
        .FALL(_MP_FALL_1785973542)
    ) latch_button_edge (
    ...
    localparam _MP_CLK_FREQ_1381992422 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_1381992422 = 5'h14;
    localparam _MP_NUM_SYNC_1381992422 = 2'h2;
    logic M_clear_button_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1381992422),
        .MIN_DELAY(_MP_MIN_DELAY_1381992422),
        .NUM_SYNC(_MP_NUM_SYNC_1381992422)
    ) clear_button (
        .in(io_button[1'h1]),
        .clk(clk),
    ...
    localparam _MP_RISE_1616521271 = 1'h1;
    localparam _MP_FALL_1616521271 = 1'h0;
    logic M_clear_button_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1616521271),
        .FALL(_MP_FALL_1616521271)
    ) clear_button_edge (
    ...
    localparam _MP_PIXEL_COUNT_1281452494 = PIXEL_COUNT;
    logic M_driver_update;
    logic [23:0] M_driver_color;
    logic M_driver_clear;
    logic [($clog2(_MP_PIXEL_COUNT_1281452494))-1:0] M_driver_pixel_address;
    logic M_driver_data;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1281452494)
    ) driver (
        .rst(rst),
        .clk(clk),
    ...
    always @* begin
        ...
        pixel_address = M_driver_pixel_address;
        for (RR_6c3defbd_index = 0; RR_6c3defbd_index < 2'h2; RR_6c3defbd_index = RR_6c3defbd_index + 1) begin
      R_6c3defbd_index = (0) + RR_6c3defbd_index * (1);
            current_pixel_color_encoding[R_6c3defbd_index] = D_led_encoding_q[2'h2 * pixel_address + R_6c3defbd_index];
        end
