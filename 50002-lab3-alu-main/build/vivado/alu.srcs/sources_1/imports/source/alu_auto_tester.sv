...
module alu_auto_tester #(
    ...
    logic slow_clock;
    localparam _MP_DIGITS_1210558890 = 3'h4;
    localparam _MP_LEADING_ZEROS_1210558890 = 1'h1;
    logic [13:0] M_pass_renderer_value;
    logic [3:0][3:0] M_pass_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1210558890),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1210558890)
    ) pass_renderer (
    ...
    localparam _MP_DIGITS_1909305662 = 3'h4;
    localparam _MP_LEADING_ZEROS_1909305662 = 1'h1;
    logic [13:0] M_error_renderer_value;
    logic [3:0][3:0] M_error_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1909305662),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1909305662)
    ) error_renderer (
    ...
    localparam _MP_DIGITS_2078252608 = 3'h4;
    localparam _MP_LEADING_ZEROS_2078252608 = 1'h1;
    logic [13:0] M_test_sel_renderer_value;
    logic [3:0][3:0] M_test_sel_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_2078252608),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_2078252608)
    ) test_sel_renderer (
    ...
    localparam logic [4:0][0:0] _MP_RISE_1761588492 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_1761588492 = {{1'h0, 1'h0, 1'h0, 1'h0, 1'h0}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    
    genvar idx_0_1761588492;
    
    generate
        for (idx_0_1761588492 = 0; idx_0_1761588492 < 5; idx_0_1761588492 = idx_0_1761588492 + 1) begin: forLoop_idx_0_1761588492
            edge_detector #(
                .RISE(_MP_RISE_1761588492[idx_0_1761588492]),
                .FALL(_MP_FALL_1761588492[idx_0_1761588492])
            ) io_button_edge (
                .clk(clk),
                .in(M_io_button_edge_in[idx_0_1761588492]),
                .out(M_io_button_edge_out[idx_0_1761588492])
            );
        end
    endgenerate
    
    
    localparam _MP_RISE_364731766 = 1'h1;
    localparam _MP_FALL_364731766 = 1'h0;
    logic M_slow_clock_edge_in;
    logic M_slow_clock_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_364731766),
        .FALL(_MP_FALL_364731766)
    ) slow_clock_edge (
        .clk(clk),
    ...
    localparam logic [4:0][26:0] _MP_CLK_FREQ_566647804 = {{27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100}};
    localparam _MP_MIN_DELAY_566647804 = 5'h14;
    localparam _MP_NUM_SYNC_566647804 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    
    genvar idx_0_566647804;
    
    generate
        for (idx_0_566647804 = 0; idx_0_566647804 < 5; idx_0_566647804 = idx_0_566647804 + 1) begin: forLoop_idx_0_566647804
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_566647804[idx_0_566647804]),
                .MIN_DELAY(_MP_MIN_DELAY_566647804),
                .NUM_SYNC(_MP_NUM_SYNC_566647804)
            ) io_button_cond (
                .clk(clk),
                .in(M_io_button_cond_in[idx_0_566647804]),
                .out(M_io_button_cond_out[idx_0_566647804])
            );
        end
    endgenerate
    
    
    localparam _MP_DIGITS_814273450 = 3'h4;
    localparam _MP_DIV_814273450 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_814273450),
        .DIV(_MP_DIV_814273450)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
