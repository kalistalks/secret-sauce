...
module alu_auto_tester #(
    ...
    logic slow_clock;
    localparam _MP_DIGITS_1201189435 = 3'h4;
    localparam _MP_LEADING_ZEROS_1201189435 = 1'h1;
    logic [13:0] M_pass_renderer_value;
    logic [3:0][3:0] M_pass_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1201189435),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1201189435)
    ) pass_renderer (
    ...
    localparam _MP_DIGITS_318992446 = 3'h4;
    localparam _MP_LEADING_ZEROS_318992446 = 1'h1;
    logic [13:0] M_error_renderer_value;
    logic [3:0][3:0] M_error_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_318992446),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_318992446)
    ) error_renderer (
    ...
    localparam _MP_DIGITS_2068314679 = 3'h4;
    localparam _MP_LEADING_ZEROS_2068314679 = 1'h1;
    logic [13:0] M_test_sel_renderer_value;
    logic [3:0][3:0] M_test_sel_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_2068314679),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_2068314679)
    ) test_sel_renderer (
    ...
    localparam logic [4:0][0:0] _MP_RISE_1927979163 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_1927979163 = {{1'h0, 1'h0, 1'h0, 1'h0, 1'h0}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    
    genvar idx_0_1927979163;
    
    generate
        for (idx_0_1927979163 = 0; idx_0_1927979163 < 5; idx_0_1927979163 = idx_0_1927979163 + 1) begin: forLoop_idx_0_1927979163
            edge_detector #(
                .RISE(_MP_RISE_1927979163[idx_0_1927979163]),
                .FALL(_MP_FALL_1927979163[idx_0_1927979163])
            ) io_button_edge (
                .clk(clk),
                .in(M_io_button_edge_in[idx_0_1927979163]),
                .out(M_io_button_edge_out[idx_0_1927979163])
            );
        end
    endgenerate
    
    
    localparam _MP_RISE_1975845979 = 1'h1;
    localparam _MP_FALL_1975845979 = 1'h0;
    logic M_slow_clock_edge_in;
    logic M_slow_clock_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1975845979),
        .FALL(_MP_FALL_1975845979)
    ) slow_clock_edge (
        .clk(clk),
    ...
    localparam logic [4:0][26:0] _MP_CLK_FREQ_1108441367 = {{27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100}};
    localparam _MP_MIN_DELAY_1108441367 = 5'h14;
    localparam _MP_NUM_SYNC_1108441367 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    
    genvar idx_0_1108441367;
    
    generate
        for (idx_0_1108441367 = 0; idx_0_1108441367 < 5; idx_0_1108441367 = idx_0_1108441367 + 1) begin: forLoop_idx_0_1108441367
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1108441367[idx_0_1108441367]),
                .MIN_DELAY(_MP_MIN_DELAY_1108441367),
                .NUM_SYNC(_MP_NUM_SYNC_1108441367)
            ) io_button_cond (
                .clk(clk),
                .in(M_io_button_cond_in[idx_0_1108441367]),
                .out(M_io_button_cond_out[idx_0_1108441367])
            );
        end
    endgenerate
    
    
    localparam _MP_DIGITS_746441986 = 3'h4;
    localparam _MP_DIV_746441986 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_746441986),
        .DIV(_MP_DIV_746441986)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
