...
module adder #(
    ...
    localparam _MP_SIZE_2083603553 = SIZE;
    logic [(_MP_SIZE_2083603553)-1:0] M_rca_a;
    logic [(_MP_SIZE_2083603553)-1:0] M_rca_b;
    logic M_rca_cin;
    logic [(_MP_SIZE_2083603553)-1:0] M_rca_s;
    
    rca #(
        .SIZE(_MP_SIZE_2083603553)
    ) rca (
        .a(M_rca_a),
        .b(M_rca_b),
        .cin(M_rca_cin),
