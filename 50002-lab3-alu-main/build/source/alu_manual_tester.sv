...
module alu_manual_tester #(
    ...
    localparam logic [4:0][0:0] _MP_RISE_1771103728 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_1771103728 = {{1'h0, 1'h0, 1'h0, 1'h0, 1'h0}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    
    genvar idx_0_1771103728;
    
    generate
        for (idx_0_1771103728 = 0; idx_0_1771103728 < 5; idx_0_1771103728 = idx_0_1771103728 + 1) begin: forLoop_idx_0_1771103728
            edge_detector #(
                .RISE(_MP_RISE_1771103728[idx_0_1771103728]),
                .FALL(_MP_FALL_1771103728[idx_0_1771103728])
            ) io_button_edge (
                .clk(clk),
                .in(M_io_button_edge_in[idx_0_1771103728]),
                .out(M_io_button_edge_out[idx_0_1771103728])
            );
        end
    endgenerate
    
    
    localparam logic [4:0][26:0] _MP_CLK_FREQ_1744242962 = {{27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100}};
    localparam _MP_MIN_DELAY_1744242962 = 5'h14;
    localparam _MP_NUM_SYNC_1744242962 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    
    genvar idx_0_1744242962;
    
    generate
        for (idx_0_1744242962 = 0; idx_0_1744242962 < 5; idx_0_1744242962 = idx_0_1744242962 + 1) begin: forLoop_idx_0_1744242962
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1744242962[idx_0_1744242962]),
                .MIN_DELAY(_MP_MIN_DELAY_1744242962),
                .NUM_SYNC(_MP_NUM_SYNC_1744242962)
            ) io_button_cond (
                .clk(clk),
                .in(M_io_button_cond_in[idx_0_1744242962]),
                .out(M_io_button_cond_out[idx_0_1744242962])
            );
        end
    endgenerate
    
    
    localparam _MP_DIGITS_1879390477 = 3'h4;
    localparam _MP_DIV_1879390477 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1879390477),
        .DIV(_MP_DIV_1879390477)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
