...
module alu_manual_tester #(
    ...
    localparam logic [4:0][0:0] _MP_RISE_304761078 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_304761078 = {{1'h0, 1'h0, 1'h0, 1'h0, 1'h0}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    
    genvar idx_0_304761078;
    
    generate
        for (idx_0_304761078 = 0; idx_0_304761078 < 5; idx_0_304761078 = idx_0_304761078 + 1) begin: forLoop_idx_0_304761078
            edge_detector #(
                .RISE(_MP_RISE_304761078[idx_0_304761078]),
                .FALL(_MP_FALL_304761078[idx_0_304761078])
            ) io_button_edge (
                .clk(clk),
                .in(M_io_button_edge_in[idx_0_304761078]),
                .out(M_io_button_edge_out[idx_0_304761078])
            );
        end
    endgenerate
    
    
    localparam logic [4:0][26:0] _MP_CLK_FREQ_1493560830 = {{27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100}};
    localparam _MP_MIN_DELAY_1493560830 = 5'h14;
    localparam _MP_NUM_SYNC_1493560830 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    
    genvar idx_0_1493560830;
    
    generate
        for (idx_0_1493560830 = 0; idx_0_1493560830 < 5; idx_0_1493560830 = idx_0_1493560830 + 1) begin: forLoop_idx_0_1493560830
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1493560830[idx_0_1493560830]),
                .MIN_DELAY(_MP_MIN_DELAY_1493560830),
                .NUM_SYNC(_MP_NUM_SYNC_1493560830)
            ) io_button_cond (
                .clk(clk),
                .in(M_io_button_cond_in[idx_0_1493560830]),
                .out(M_io_button_cond_out[idx_0_1493560830])
            );
        end
    endgenerate
    
    
    localparam _MP_DIGITS_1634585963 = 3'h4;
    localparam _MP_DIV_1634585963 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1634585963),
        .DIV(_MP_DIV_1634585963)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
