...
module alchitry_top (
    ...
    localparam _MP_STAGES_146021096 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_146021096)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_1291028384 = 3'h4;
    logic M_external_reset_cond_in;
    logic M_external_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1291028384)
    ) external_reset_cond (
        .clk(clk),
    ...
    localparam _MP_RISE_486226740 = 1'h1;
    localparam _MP_FALL_486226740 = 1'h0;
    logic M_edge_dt_p1_button_left_in;
    logic M_edge_dt_p1_button_left_out;
    
    edge_detector #(
        .RISE(_MP_RISE_486226740),
        .FALL(_MP_FALL_486226740)
    ...
    localparam _MP_RISE_1713113793 = 1'h1;
    localparam _MP_FALL_1713113793 = 1'h0;
    logic M_edge_dt_p1_button_right_in;
    logic M_edge_dt_p1_button_right_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1713113793),
        .FALL(_MP_FALL_1713113793)
    ...
    localparam _MP_RISE_1346450720 = 1'h1;
    localparam _MP_FALL_1346450720 = 1'h0;
    logic M_edge_dt_p1_button_flip_in;
    logic M_edge_dt_p1_button_flip_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1346450720),
        .FALL(_MP_FALL_1346450720)
    ...
    localparam _MP_RISE_1519905911 = 1'h1;
    localparam _MP_FALL_1519905911 = 1'h0;
    logic M_edge_dt_p2_button_left_in;
    logic M_edge_dt_p2_button_left_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1519905911),
        .FALL(_MP_FALL_1519905911)
    ...
    localparam _MP_RISE_440247973 = 1'h1;
    localparam _MP_FALL_440247973 = 1'h0;
    logic M_edge_dt_p2_button_right_in;
    logic M_edge_dt_p2_button_right_out;
    
    edge_detector #(
        .RISE(_MP_RISE_440247973),
        .FALL(_MP_FALL_440247973)
    ...
    localparam _MP_RISE_786365374 = 1'h1;
    localparam _MP_FALL_786365374 = 1'h0;
    logic M_edge_dt_p2_button_flip_in;
    logic M_edge_dt_p2_button_flip_out;
    
    edge_detector #(
        .RISE(_MP_RISE_786365374),
        .FALL(_MP_FALL_786365374)
    ...
    localparam _MP_CLK_FREQ_1727830320 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_1727830320 = 5'h14;
    localparam _MP_NUM_SYNC_1727830320 = 2'h2;
    logic M_btn_cond_p1_button_left_in;
    logic M_btn_cond_p1_button_left_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1727830320),
        .MIN_DELAY(_MP_MIN_DELAY_1727830320),
        .NUM_SYNC(_MP_NUM_SYNC_1727830320)
    ...
    localparam _MP_CLK_FREQ_918271612 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_918271612 = 5'h14;
    localparam _MP_NUM_SYNC_918271612 = 2'h2;
    logic M_btn_cond_p1_button_right_in;
    logic M_btn_cond_p1_button_right_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_918271612),
        .MIN_DELAY(_MP_MIN_DELAY_918271612),
        .NUM_SYNC(_MP_NUM_SYNC_918271612)
    ...
    localparam _MP_CLK_FREQ_1823750871 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_1823750871 = 5'h14;
    localparam _MP_NUM_SYNC_1823750871 = 2'h2;
    logic M_btn_cond_p1_button_flip_in;
    logic M_btn_cond_p1_button_flip_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1823750871),
        .MIN_DELAY(_MP_MIN_DELAY_1823750871),
        .NUM_SYNC(_MP_NUM_SYNC_1823750871)
    ...
    localparam _MP_CLK_FREQ_188780542 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_188780542 = 5'h14;
    localparam _MP_NUM_SYNC_188780542 = 2'h2;
    logic M_btn_cond_p2_button_left_in;
    logic M_btn_cond_p2_button_left_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_188780542),
        .MIN_DELAY(_MP_MIN_DELAY_188780542),
        .NUM_SYNC(_MP_NUM_SYNC_188780542)
    ...
    localparam _MP_CLK_FREQ_1474720978 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_1474720978 = 5'h14;
    localparam _MP_NUM_SYNC_1474720978 = 2'h2;
    logic M_btn_cond_p2_button_right_in;
    logic M_btn_cond_p2_button_right_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1474720978),
        .MIN_DELAY(_MP_MIN_DELAY_1474720978),
        .NUM_SYNC(_MP_NUM_SYNC_1474720978)
    ...
    localparam _MP_CLK_FREQ_1015357444 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_1015357444 = 5'h14;
    localparam _MP_NUM_SYNC_1015357444 = 2'h2;
    logic M_btn_cond_p2_button_flip_in;
    logic M_btn_cond_p2_button_flip_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1015357444),
        .MIN_DELAY(_MP_MIN_DELAY_1015357444),
        .NUM_SYNC(_MP_NUM_SYNC_1015357444)
    ...
    localparam _MP_DIGITS_1898629057 = 3'h6;
    localparam _MP_DIV_1898629057 = 5'h10;
    logic [5:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [5:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1898629057),
        .DIV(_MP_DIV_1898629057)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
    ...
    localparam _MP_SLOW_CLOCK_DIV_254719187 = 5'h1a;
    localparam _MP_FAST_CLOCK_DIV_254719187 = 5'h15;
    ...
    game_datapath #(
        .SLOW_CLOCK_DIV(_MP_SLOW_CLOCK_DIV_254719187),
        .FAST_CLOCK_DIV(_MP_FAST_CLOCK_DIV_254719187)
    ) game_datapath (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_PIXEL_COUNT_681406008 = 4'hc;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_681406008)
    ) p1_chef_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_40279039 = 4'hc;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_40279039)
    ) p2_chef_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_1772585729 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1772585729)
    ) lane_1_sushi_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_324352714 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_324352714)
    ) lane_2_sushi_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_1358588470 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1358588470)
    ) lane_3_sushi_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_1718987445 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1718987445)
    ) lane_4_sushi_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_857703153 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_857703153)
    ) lane_1_color_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_161901874 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_161901874)
    ) lane_2_color_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_168697322 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_168697322)
    ) lane_3_color_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_1097154076 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1097154076)
    ) lane_4_color_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_DIGITS_878122960 = 2'h2;
    localparam _MP_LEADING_ZEROS_878122960 = 1'h0;
    logic [6:0] M_timer_bin_to_dec_converter_value;
    logic [1:0][3:0] M_timer_bin_to_dec_converter_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_878122960),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_878122960)
    ...
    localparam _MP_DIGITS_507976420 = 2'h2;
    localparam _MP_LEADING_ZEROS_507976420 = 1'h0;
    logic [6:0] M_p1_score_bin_to_dec_converter_value;
    logic [1:0][3:0] M_p1_score_bin_to_dec_converter_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_507976420),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_507976420)
    ...
    localparam _MP_DIGITS_916421358 = 2'h2;
    localparam _MP_LEADING_ZEROS_916421358 = 1'h0;
    logic [6:0] M_p2_score_bin_to_dec_converter_value;
    logic [1:0][3:0] M_p2_score_bin_to_dec_converter_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_916421358),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_916421358)
    ...
    always @* begin
        ...
        M_seg_values = {{4'h0, 4'h0, 4'h0, 4'h0, 4'h0, 4'h0}};
        M_p1_score_bin_to_dec_converter_value = M_game_datapath_p1_score_out[3'h6:1'h0];
        M_p2_score_bin_to_dec_converter_value = M_game_datapath_p2_score_out[3'h6:1'h0];
