...
module alchitry_top (
    ...
    localparam _MP_STAGES_1827076961 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1827076961)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_1072809051 = 3'h4;
    logic M_external_reset_cond_in;
    logic M_external_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1072809051)
    ) external_reset_cond (
        .clk(clk),
    ...
    localparam _MP_RISE_2074190377 = 1'h1;
    localparam _MP_FALL_2074190377 = 1'h0;
    logic M_edge_dt_p1_button_left_in;
    logic M_edge_dt_p1_button_left_out;
    
    edge_detector #(
        .RISE(_MP_RISE_2074190377),
        .FALL(_MP_FALL_2074190377)
    ...
    localparam _MP_RISE_580452291 = 1'h1;
    localparam _MP_FALL_580452291 = 1'h0;
    logic M_edge_dt_p1_button_right_in;
    logic M_edge_dt_p1_button_right_out;
    
    edge_detector #(
        .RISE(_MP_RISE_580452291),
        .FALL(_MP_FALL_580452291)
    ...
    localparam _MP_RISE_1738920053 = 1'h1;
    localparam _MP_FALL_1738920053 = 1'h0;
    logic M_edge_dt_p1_button_flip_in;
    logic M_edge_dt_p1_button_flip_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1738920053),
        .FALL(_MP_FALL_1738920053)
    ...
    localparam _MP_RISE_815582537 = 1'h1;
    localparam _MP_FALL_815582537 = 1'h0;
    logic M_edge_dt_p2_button_left_in;
    logic M_edge_dt_p2_button_left_out;
    
    edge_detector #(
        .RISE(_MP_RISE_815582537),
        .FALL(_MP_FALL_815582537)
    ...
    localparam _MP_RISE_1489041461 = 1'h1;
    localparam _MP_FALL_1489041461 = 1'h0;
    logic M_edge_dt_p2_button_right_in;
    logic M_edge_dt_p2_button_right_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1489041461),
        .FALL(_MP_FALL_1489041461)
    ...
    localparam _MP_RISE_1723367784 = 1'h1;
    localparam _MP_FALL_1723367784 = 1'h0;
    logic M_edge_dt_p2_button_flip_in;
    logic M_edge_dt_p2_button_flip_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1723367784),
        .FALL(_MP_FALL_1723367784)
    ...
    localparam _MP_CLK_FREQ_986772701 = 24'h989680;
    localparam _MP_MIN_DELAY_986772701 = 5'h14;
    localparam _MP_NUM_SYNC_986772701 = 2'h2;
    logic M_btn_cond_p1_button_left_in;
    logic M_btn_cond_p1_button_left_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_986772701),
        .MIN_DELAY(_MP_MIN_DELAY_986772701),
        .NUM_SYNC(_MP_NUM_SYNC_986772701)
    ...
    localparam _MP_CLK_FREQ_395233834 = 24'h989680;
    localparam _MP_MIN_DELAY_395233834 = 5'h14;
    localparam _MP_NUM_SYNC_395233834 = 2'h2;
    logic M_btn_cond_p1_button_right_in;
    logic M_btn_cond_p1_button_right_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_395233834),
        .MIN_DELAY(_MP_MIN_DELAY_395233834),
        .NUM_SYNC(_MP_NUM_SYNC_395233834)
    ...
    localparam _MP_CLK_FREQ_1750742330 = 24'h989680;
    localparam _MP_MIN_DELAY_1750742330 = 5'h14;
    localparam _MP_NUM_SYNC_1750742330 = 2'h2;
    logic M_btn_cond_p1_button_flip_in;
    logic M_btn_cond_p1_button_flip_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1750742330),
        .MIN_DELAY(_MP_MIN_DELAY_1750742330),
        .NUM_SYNC(_MP_NUM_SYNC_1750742330)
    ...
    localparam _MP_CLK_FREQ_449164122 = 24'h989680;
    localparam _MP_MIN_DELAY_449164122 = 5'h14;
    localparam _MP_NUM_SYNC_449164122 = 2'h2;
    logic M_btn_cond_p2_button_left_in;
    logic M_btn_cond_p2_button_left_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_449164122),
        .MIN_DELAY(_MP_MIN_DELAY_449164122),
        .NUM_SYNC(_MP_NUM_SYNC_449164122)
    ...
    localparam _MP_CLK_FREQ_236975382 = 24'h989680;
    localparam _MP_MIN_DELAY_236975382 = 5'h14;
    localparam _MP_NUM_SYNC_236975382 = 2'h2;
    logic M_btn_cond_p2_button_right_in;
    logic M_btn_cond_p2_button_right_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_236975382),
        .MIN_DELAY(_MP_MIN_DELAY_236975382),
        .NUM_SYNC(_MP_NUM_SYNC_236975382)
    ...
    localparam _MP_CLK_FREQ_1872863589 = 24'h989680;
    localparam _MP_MIN_DELAY_1872863589 = 5'h14;
    localparam _MP_NUM_SYNC_1872863589 = 2'h2;
    logic M_btn_cond_p2_button_flip_in;
    logic M_btn_cond_p2_button_flip_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1872863589),
        .MIN_DELAY(_MP_MIN_DELAY_1872863589),
        .NUM_SYNC(_MP_NUM_SYNC_1872863589)
    ...
    localparam _MP_DIGITS_1458285134 = 3'h6;
    localparam _MP_DIV_1458285134 = 5'h10;
    logic [5:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [5:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1458285134),
        .DIV(_MP_DIV_1458285134)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
    ...
    localparam _MP_SLOW_CLOCK_DIV_1921860397 = 5'h1a;
    localparam _MP_FAST_CLOCK_DIV_1921860397 = 5'h15;
    ...
    game_datapath #(
        .SLOW_CLOCK_DIV(_MP_SLOW_CLOCK_DIV_1921860397),
        .FAST_CLOCK_DIV(_MP_FAST_CLOCK_DIV_1921860397)
    ) game_datapath (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_PIXEL_COUNT_2034183912 = 4'hc;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_2034183912)
    ) p1_chef_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_69471145 = 4'hc;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_69471145)
    ) p2_chef_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_1070395982 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1070395982)
    ) lane_1_sushi_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_658524849 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_658524849)
    ) lane_2_sushi_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_663251167 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_663251167)
    ) lane_3_sushi_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_55920324 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_55920324)
    ) lane_4_sushi_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_1532205666 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1532205666)
    ) lane_1_color_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_2120435323 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_2120435323)
    ) lane_2_color_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_440997880 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_440997880)
    ) lane_3_color_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_PIXEL_COUNT_864223507 = 5'h15;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_864223507)
    ) lane_4_color_driver (
        .clk(clk),
        .rst(rst),
        .clear(1'h0),
    ...
    localparam _MP_DIGITS_284220918 = 2'h2;
    localparam _MP_LEADING_ZEROS_284220918 = 1'h0;
    logic [6:0] M_timer_bin_to_dec_converter_value;
    logic [1:0][3:0] M_timer_bin_to_dec_converter_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_284220918),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_284220918)
    ...
    localparam _MP_DIGITS_1313210540 = 2'h2;
    localparam _MP_LEADING_ZEROS_1313210540 = 1'h0;
    logic [6:0] M_p1_score_bin_to_dec_converter_value;
    logic [1:0][3:0] M_p1_score_bin_to_dec_converter_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1313210540),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1313210540)
    ...
    localparam _MP_DIGITS_589046626 = 2'h2;
    localparam _MP_LEADING_ZEROS_589046626 = 1'h0;
    logic [6:0] M_p2_score_bin_to_dec_converter_value;
    logic [1:0][3:0] M_p2_score_bin_to_dec_converter_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_589046626),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_589046626)
