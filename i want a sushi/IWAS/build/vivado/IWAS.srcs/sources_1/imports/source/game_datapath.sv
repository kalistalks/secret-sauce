...
module game_datapath #(
    ...
    localparam _MP_SIZE_2030255664 = 1'h1;
    localparam _MP_DIV_2030255664 = SLOW_CLOCK_DIV;
    localparam _MP_TOP_2030255664 = 1'h0;
    localparam _MP_UP_2030255664 = 1'h1;
    logic [0:0] M_game_timer_clock_value;
    
    counter #(
        .SIZE(_MP_SIZE_2030255664),
        .DIV(_MP_DIV_2030255664),
        .TOP(_MP_TOP_2030255664),
        .UP(_MP_UP_2030255664)
    ) game_timer_clock (
        .rst(rst),
        .clk(clk),
    ...
    localparam _MP_RISE_1101998365 = 1'h1;
    localparam _MP_FALL_1101998365 = 1'h0;
    logic M_edge_detector_game_timer_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1101998365),
        .FALL(_MP_FALL_1101998365)
